...
discontinuous_regs =pkl.load(open(os.path.join("Modules/CATH/discontinuous/discontinuous_regs.pkl")))
...
for line in open("Modules/CATH/cath_release/cath-domain-list.txt"):
